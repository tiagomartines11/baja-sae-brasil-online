...
echo '<div style="margin: 0 auto;"><table id="myTable" class="tablesorter">';
echo '<thead>
        <tr>
            <th colspan="'.(4 + count($colunas)).'" class="sorter-false" style="font-size: 20px; line-height: 22px;">'.$prova->getNome().' <span style="float: left;"><a href="index.php" style="color: white; font-size: 12px;">&nbsp;Voltar</a></span></th>
        </tr>
        <tr> 
			<th>#</th>
			<th>Equipe</th>
