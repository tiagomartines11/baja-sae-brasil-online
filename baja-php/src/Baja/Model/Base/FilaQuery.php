 ...
 *
 * @method     ChildFila|null findOne(?ConnectionInterface $con = null) Return the first ChildFila matching the query
 ...
 *
 * @method     ChildFila|null findOneByEventoId(string $evento_id) Return the first ChildFila filtered by the evento_id column
 * @method     ChildFila|null findOneByFilaId(int $fila_id) Return the first ChildFila filtered by the fila_id column
 * @method     ChildFila|null findOneByNome(string $nome) Return the first ChildFila filtered by the nome column
 * @method     ChildFila|null findOneByStatus(int $status) Return the first ChildFila filtered by the status column
 * @method     ChildFila|null findOneByPermiteTroca(boolean $permite_troca) Return the first ChildFila filtered by the permite_troca column
 * @method     ChildFila|null findOneByPermiteMultiplas(boolean $permite_multiplas) Return the first ChildFila filtered by the permite_multiplas column
 * @method     ChildFila|null findOneByPermiteChamadaEspera(boolean $permite_chamada_espera) Return the first ChildFila filtered by the permite_chamada_espera column
 * @method     ChildFila|null findOneByTempoEspera(int $tempo_espera) Return the first ChildFila filtered by the tempo_espera column
 * @method     ChildFila|null findOneByAberturaProgramada(string $abertura_programada) Return the first ChildFila filtered by the abertura_programada column
 * @method     ChildFila|null findOneByFechamentoProgramado(string $fechamento_programado) Return the first ChildFila filtered by the fechamento_programado column
 *
 ...
 *
 * @method     ChildFila[]|Collection find(?ConnectionInterface $con = null) Return ChildFila objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildFila> find(?ConnectionInterface $con = null) Return ChildFila objects based on current ModelCriteria
 *
 * @method     ChildFila[]|Collection findByEventoId(string|array<string> $evento_id) Return ChildFila objects filtered by the evento_id column
 * @psalm-method Collection&\Traversable<ChildFila> findByEventoId(string|array<string> $evento_id) Return ChildFila objects filtered by the evento_id column
 * @method     ChildFila[]|Collection findByFilaId(int|array<int> $fila_id) Return ChildFila objects filtered by the fila_id column
 * @psalm-method Collection&\Traversable<ChildFila> findByFilaId(int|array<int> $fila_id) Return ChildFila objects filtered by the fila_id column
 * @method     ChildFila[]|Collection findByNome(string|array<string> $nome) Return ChildFila objects filtered by the nome column
 * @psalm-method Collection&\Traversable<ChildFila> findByNome(string|array<string> $nome) Return ChildFila objects filtered by the nome column
 * @method     ChildFila[]|Collection findByStatus(int|array<int> $status) Return ChildFila objects filtered by the status column
 * @psalm-method Collection&\Traversable<ChildFila> findByStatus(int|array<int> $status) Return ChildFila objects filtered by the status column
 * @method     ChildFila[]|Collection findByPermiteTroca(boolean|array<boolean> $permite_troca) Return ChildFila objects filtered by the permite_troca column
 * @psalm-method Collection&\Traversable<ChildFila> findByPermiteTroca(boolean|array<boolean> $permite_troca) Return ChildFila objects filtered by the permite_troca column
 * @method     ChildFila[]|Collection findByPermiteMultiplas(boolean|array<boolean> $permite_multiplas) Return ChildFila objects filtered by the permite_multiplas column
 * @psalm-method Collection&\Traversable<ChildFila> findByPermiteMultiplas(boolean|array<boolean> $permite_multiplas) Return ChildFila objects filtered by the permite_multiplas column
 * @method     ChildFila[]|Collection findByPermiteChamadaEspera(boolean|array<boolean> $permite_chamada_espera) Return ChildFila objects filtered by the permite_chamada_espera column
 * @psalm-method Collection&\Traversable<ChildFila> findByPermiteChamadaEspera(boolean|array<boolean> $permite_chamada_espera) Return ChildFila objects filtered by the permite_chamada_espera column
 * @method     ChildFila[]|Collection findByTempoEspera(int|array<int> $tempo_espera) Return ChildFila objects filtered by the tempo_espera column
 * @psalm-method Collection&\Traversable<ChildFila> findByTempoEspera(int|array<int> $tempo_espera) Return ChildFila objects filtered by the tempo_espera column
 * @method     ChildFila[]|Collection findByAberturaProgramada(string|array<string> $abertura_programada) Return ChildFila objects filtered by the abertura_programada column
 * @psalm-method Collection&\Traversable<ChildFila> findByAberturaProgramada(string|array<string> $abertura_programada) Return ChildFila objects filtered by the abertura_programada column
 * @method     ChildFila[]|Collection findByFechamentoProgramado(string|array<string> $fechamento_programado) Return ChildFila objects filtered by the fechamento_programado column
 * @psalm-method Collection&\Traversable<ChildFila> findByFechamentoProgramado(string|array<string> $fechamento_programado) Return ChildFila objects filtered by the fechamento_programado column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildFila> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class FilaQuery extends ModelCriteria
{
    ...
    public function filterByEventoId($eventoId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_EVENTO_ID, $eventoId, $comparison);
    ...
    public function filterByFilaId($filaId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_FILA_ID, $filaId, $comparison);
    ...
    public function filterByNome($nome = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_NOME, $nome, $comparison);
    ...
    public function filterByStatus($status = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_STATUS, $status, $comparison);
     ...
     * </code>
     *
     * @param bool|string $permiteTroca The value to use as filter.
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPermiteTroca($permiteTroca = null, ?string $comparison = null)
    {
        if (is_string($permiteTroca)) {
            $permiteTroca = in_array(strtolower($permiteTroca), array('false', 'off', '-', 'no', 'n', '0', ''), true) ? false : true;
        }

        $this->addUsingAlias(FilaTableMap::COL_PERMITE_TROCA, $permiteTroca, $comparison);
     ...
     * </code>
     *
     * @param bool|string $permiteMultiplas The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPermiteMultiplas($permiteMultiplas = null, ?string $comparison = null)
    {
        if (is_string($permiteMultiplas)) {
            $permiteMultiplas = in_array(strtolower($permiteMultiplas), array('false', 'off', '-', 'no', 'n', '0', ''), true) ? false : true;
        }

        $this->addUsingAlias(FilaTableMap::COL_PERMITE_MULTIPLAS, $permiteMultiplas, $comparison);
     ...
     * </code>
     *
     * @param bool|string $permiteChamadaEspera The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPermiteChamadaEspera($permiteChamadaEspera = null, ?string $comparison = null)
    {
        if (is_string($permiteChamadaEspera)) {
            $permiteChamadaEspera = in_array(strtolower($permiteChamadaEspera), array('false', 'off', '-', 'no', 'n', '0', ''), true) ? false : true;
        }

        $this->addUsingAlias(FilaTableMap::COL_PERMITE_CHAMADA_ESPERA, $permiteChamadaEspera, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByTempoEspera($tempoEspera = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_TEMPO_ESPERA, $tempoEspera, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByAberturaProgramada($aberturaProgramada = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_ABERTURA_PROGRAMADA, $aberturaProgramada, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByFechamentoProgramado($fechamentoProgramado = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(FilaTableMap::COL_FECHAMENTO_PROGRAMADO, $fechamentoProgramado, $comparison);
