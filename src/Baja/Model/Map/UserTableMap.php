...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Baja.Model.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\Baja\\Model\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Baja.Model.User';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'Username', 'Permissions', 'LastLogin', ),
        self::TYPE_CAMELNAME     => array('userId', 'username', 'permissions', 'lastLogin', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID, UserTableMap::COL_USERNAME, UserTableMap::COL_PERMISSIONS, UserTableMap::COL_LAST_LOGIN, ),
        self::TYPE_FIELDNAME     => array('user_id', 'username', 'permissions', 'last_login', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'Username' => 1, 'Permissions' => 2, 'LastLogin' => 3, ),
        self::TYPE_CAMELNAME     => array('userId' => 0, 'username' => 1, 'permissions' => 2, 'lastLogin' => 3, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID => 0, UserTableMap::COL_USERNAME => 1, UserTableMap::COL_PERMISSIONS => 2, UserTableMap::COL_LAST_LOGIN => 3, ),
        self::TYPE_FIELDNAME     => array('user_id' => 0, 'username' => 1, 'permissions' => 2, 'last_login' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
