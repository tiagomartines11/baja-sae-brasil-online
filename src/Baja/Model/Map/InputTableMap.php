...
class InputTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Baja\\Model\\Input');
        $this->setPackage('Baja.Model');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('evento_id', 'EventoId', 'CHAR' , 'prova', 'evento_id', true, 4, null);
        $this->addForeignPrimaryKey('evento_id', 'EventoId', 'CHAR' , 'equipe', 'evento_id', true, 4, null);
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getEventoId() || is_scalar($obj->getEventoId()) || is_callable([$obj->getEventoId(), '__toString']) ? (string) $obj->getEventoId() : $obj->getEventoId()), (null === $obj->getProvaId() || is_scalar($obj->getProvaId()) || is_callable([$obj->getProvaId(), '__toString']) ? (string) $obj->getProvaId() : $obj->getProvaId()), (null === $obj->getEquipeId() || is_scalar($obj->getEquipeId()) || is_callable([$obj->getEquipeId(), '__toString']) ? (string) $obj->getEquipeId() : $obj->getEquipeId())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Baja\Model\Input) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Baja\Model\Input object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(InputTableMap::COL_PROVA_ID);
            $criteria->addSelectColumn(InputTableMap::COL_EQUIPE_ID);
            $criteria->addSelectColumn(InputTableMap::COL_DADOS);
            $criteria->addSelectColumn(InputTableMap::COL_VARS);
            $criteria->addSelectColumn(InputTableMap::COL_PONTOS);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.vars');
            $criteria->addSelectColumn($alias . '.pontos');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Baja\Model\Input) { // it's a model object
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(InputTableMap::COL_PROVA_ID, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(InputTableMap::COL_EQUIPE_ID, $value[2]));
