...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Baja\\Model\\Map\\UserTableMap';
    ...
    public function getPermissions()
    {
        if (null === $this->permissions_unserialized) {
            $this->permissions_unserialized = array();
        }
     ...
     * @return $this|\Baja\Model\User The current object (for fluent API support)
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Baja\Model\User The current object, for fluid interface
     */
